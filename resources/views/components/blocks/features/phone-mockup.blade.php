    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
            <h2 class="text-3xl font-medium tracking-tight text-white">Every feature you need to win. Try it for
                yourself.</h2>
            <p class="mt-2 text-lg text-gray-400">Pocket was built for investors like you who play by their own rules and
                aren’t going to let SEC regulations get in the way of their dreams. If other investing tools are afraid
                to build it, Pocket has it.</p>
        </div>
    </div>
        ...
        <div
            ...
            <div class="w-full flex-none snap-center px-4 sm:px-6">
                <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"><svg viewBox="0 0 558 558"
                            width="558" height="558" fill="none" aria-hidden="true">
                            <defs>
                    ...
                    <div class="relative aspect-366/729 relative mx-auto w-full max-w-[366px]">
                        ...
                        <div
                            ...
                            style="color:transparent" src="/_next/static/media/phone-frame.d4b6b62a.svg">
                    </div>
                    <div class="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur-sm sm:p-10"><svg
                        ...
                        <h3 class="mt-6 text-sm font-semibold text-white sm:text-lg">Invite friends for better returns
                        </h3>
                        <p class="mt-2 text-sm text-gray-400">For every friend you invite to Pocket, you get insider
                            notifications 5 seconds sooner. And it’s 10 seconds if you invite an insider.</p>
                    </div>
                </div>
            </div>
            <div class="w-full flex-none snap-center px-4 sm:px-6">
                <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"><svg
                                ...
                                <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                                    <div class="divide-y divide-gray-100">
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#F9322C"><svg
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-cyan-500">+4.98%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#5A67D8"><svg
                                                    viewBox="0 0 40 40" fill="#fff" aria-hidden="true"
                                                    class="h-10 w-10">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-gray-500">-3.38%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#2A5B94"><svg
                                                    viewBox="0 0 40 40" fill="#fff" aria-hidden="true"
                                                    class="h-10 w-10">
                                                    <path
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-cyan-500">+6.25%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#3320A7"><svg
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-cyan-500">+1.25%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#2A3034"><svg
                                                    viewBox="0 0 40 40" fill="#fff" aria-hidden="true"
                                                    class="h-10 w-10">
                                                    <path
                                        ...
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#0EA5E9"><svg
                                                    viewBox="0 0 40 40" fill="#fff" aria-hidden="true"
                                                    class="h-10 w-10">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-gray-500">-3.11%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#16A34A"><svg
                                                    viewBox="0 0 40 40" fill="#fff" aria-hidden="true"
                                                    class="h-10 w-10">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-cyan-500">+9.09%</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4 px-4 py-3">
                                            <div class="flex-none rounded-full" style="background-color:#8D8D8D"><svg
                                            ...
                                            <div class="flex-none text-right">
                                                ...
                                                <div class="text-xs/5 text-gray-500">-1.25%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur-sm sm:p-10"><svg
                        ...
                        <p class="mt-2 text-sm text-gray-400">Get a push notification every time we find out something
                            that’s going to lower the share price on your holdings so you can sell before the
                            information hits the public markets.</p>
                    </div>
                </div>
            </div>
            <div class="w-full flex-none snap-center px-4 sm:px-6">
                <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                        ...
                        <div
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <div class="mt-6 px-4 text-white">
                                    ...
                                    <div class="text-sm text-gray-500"><span class="text-white">$34.28</span> per
                                        share</div>
                                </div>
                                <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                                    <div class="px-4 py-6">
                    ...
                    <div class="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur-sm sm:p-10"><svg
                        ...
                        <p class="mt-2 text-sm text-gray-400">We hide your stock purchases behind thousands of
                            anonymous trading accounts, so suspicious activity can never be traced back to you.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                    ...
                    <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                        ...
                        <h3 class="mt-6 text-lg font-semibold text-white"><button
                                class="text-left data-selected:not-data-focus:outline-hidden"
                    ...
                    <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                        ...
                        <h3 class="mt-6 text-lg font-semibold text-white"><button
                                ...
                                aria-selected="false" tabindex="-1" data-headlessui-state=""><span
                                    class="absolute inset-0 rounded-2xl"></span>Notifications on stock dips</button>
                        </h3>
                        <p class="mt-2 text-sm text-gray-400">Get a push notification every time we find out something
                            that’s going to lower the share price on your holdings so you can sell before the
                            information hits the public markets.</p>
                ...
                <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                    <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" fill="none" aria-hidden="true"
                        ...
                        <h3 class="mt-6 text-lg font-semibold text-white"><button
                                ...
                                aria-selected="false" tabindex="-1" data-headlessui-state=""><span
                                    class="absolute inset-0 rounded-2xl"></span>Invest what you want</button></h3>
                        <p class="mt-2 text-sm text-gray-400">We hide your stock purchases behind thousands of
                            anonymous trading accounts, so suspicious activity can never be traced back to you.</p>
                    </div>
                </div>
            ...
            <div class="relative col-span-6">
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"><svg viewBox="0 0 558 558"
                        ...
                        <path opacity=".2"
                            d="M1 279C1 125.465 125.465 1 279 1s278 124.465 278 278-124.465 278-278 278S1 432.535 1 279Z"
                            stroke="#13B5C8"></path>
                        <path d="M1 279C1 125.465 125.465 1 279 1" stroke="url(#:R1ll7qfja:)" stroke-linecap="round">
                        </path>
                    </svg></div>
                <div class="relative aspect-366/729 z-10 mx-auto w-full max-w-[366px]">
                    ...
                    <div
                        ...
                        <div class="absolute inset-0">
                            <img src="{{ $data['mockup_image'] }}" alt="Mockup image" />
                        </div>
                        {{-- <div class="col-start-1 row-start-1 flex focus:outline-offset-[32px] data-selected:not-data-focus:outline-hidden"
                            id="headlessui-tabs-panel-:R3all7qfja:" role="tabpanel" tabindex="0"
                            data-headlessui-state="selected" data-selected=""
                            aria-labelledby="headlessui-tabs-tab-:R19dl7qfja:">
                            <div class="flex flex-col w-full">
                                <div class="flex justify-between px-4 pt-4"><svg viewBox="0 0 24 24" fill="none"
                                        aria-hidden="true" class="h-6 w-6 flex-none">
                                        <path d="M5 6h14M5 18h14M5 12h14" stroke="#fff" stroke-width="2"
